...
def logout_view(request):
    ...
    # 메시지 프레임워크를 통해 모든 메시지를 제거
    for message in messages.get_messages(request):
        pass  # 메시지의 used 속성을 설정하여 클리어
    
    return redirect('home')  # 홈 페이지로 리다이렉션
...
# 모델 정보 딕셔너리 정의
model_info_dict = {
    "One piece": [r"가중치/onepiece_006.pth", 2],
    "Bottom": [r"가중치/bottom_050.pth", 3],
    "Top": [r"가중치/top_034.pth", 5]
